...
var aliceSharedSecret = aliceKeys.privateKey.deriveSharedSecret(
  bobKeys.publicKey
);
console.log("shared secret:", aliceSharedSecret.toString("hex"));

// Checking that Bob has the same secret:
var bobSharedSecret = bobKeys.privateKey.deriveSharedSecret(
    aliceKeys.publicKey
  ),
  equals =
    bobSharedSecret.toString("hex") === aliceSharedSecret.toString("hex");
